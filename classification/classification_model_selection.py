...
classifiers = {"svm_linear":svm.SVC(kernel='linear'), "svm_polynomial":svm.SVC(kernel='poly'), "svm_rbf":svm.SVC(kernel='rbf'),
              "logistic":LogisticRegression(), "knn": KNeighborsClassifier(), "decision_tree" : DecisionTreeClassifier(),
               "random_forest": RandomForestClassifier()
              }

parameters = {"svm_linear":svm_linear, "svm_polynomial":svm_polynomial, "svm_rbf":svm_rbf,
              "logistic":logistic, "knn":knn, "decision_tree":decision_tree,
